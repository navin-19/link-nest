...
function SettingsContent() {
  ...
  // If someone visits ?tab=customer-form, redirect to dedicated Customer Form route
  useEffect(() => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 text-slate-900 dark:text-slate-100 pb-16">
      {/* Page Header */}
      <div>
        ...
        <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 mt-1.5 leading-relaxed">
          Manage your digital profile information, username, and avatar.
        </p>
      </div>

      {/* Profile Information Card */}
      <div className="max-w-2xl p-6 sm:p-8 rounded-3xl border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-[#0c0f1d] shadow-card space-y-6 animate-in fade-in duration-150">
        {message && (
