...
export default function LocationHoursPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10 text-slate-900 dark:text-slate-100 animate-in fade-in duration-150">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <Heading as="h1" className="text-2xl sm:text-3xl lg:text-[34px] font-extrabold text-slate-900 dark:text-white tracking-tight leading-tight flex items-center gap-2.5">
                <MapPin className="text-emerald-500 shrink-0" size={28} />
                <span>Location & Business Hours</span>
              </Heading>
            </div>
            <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
              Search Google Maps for your business location, configure opening hours, and direct reach options.
            </p>
          </div>
