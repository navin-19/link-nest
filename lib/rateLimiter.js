 ...
 * @param {string} targetId - UUID of the target link or product
 ...
 */
export async function checkRateLimit(ip, targetId, isProduct = false) {
  if (!ip || !targetId) {
  ...
  try {
    ...
    const idColumn = isProduct ? 'product_id' : 'link_id';
